                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="single-feature text-center item-padding">
                                <img src="./User/assets/images/feature1.png" alt="">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-feature text-center item-padding mt-4 mt-md-0">
                                <img src="./User/assets/images/feature2.png" alt="">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                                <img src="./User/assets/images/feature3.png" alt="">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                                <img src="./User/assets/images/feature4.png" alt="">
                        ...
                        <div class="col-lg-12">
                            <div class="department-slider owl-carousel">
                                <div class="single-slide">
                                    <div class="slide-img">
                                        <img src="./User/assets/images/department1.jpg" alt="" class="img-fluid">
                                ...
                                <div class="single-slide">
                                    <div class="slide-img">
                                        <img src="./User/assets/images/department2.jpg" alt="" class="img-fluid">
                                        <div class="hover-state">
                                ...
                                <div class="single-slide">
                                    <div class="slide-img">
                                        <img src="./User/assets/images/department3.jpg" alt="" class="img-fluid">
                                        <div class="hover-state">
                                            <a href="departments.html"><i class="fa fa-stethoscope"></i></a>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single-news">
                                <div class="news-img">
                                    <img src="./User/assets/images/news1.jpg" alt="" class="img-fluid">
                                </div>
                                <div class="news-text">
                                    <div class="news-date">
                                        22 July 2018
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-news mt-5 mt-md-0">
                                <div class="news-img">
                                    <img src="./User/assets/images/news2.jpg" alt="" class="img-fluid">
                                </div>
                                <div class="news-text">
                                    <div class="news-date">
                                        22 Oct 2018
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-news mt-5 mt-lg-0">
                                <div class="news-img">
                                    <img src="./User/assets/images/news3.jpg" alt="" class="img-fluid">
                                </div>
                                <div class="news-text">
                                    <div class="news-date">
                                        22 Sep 2018
